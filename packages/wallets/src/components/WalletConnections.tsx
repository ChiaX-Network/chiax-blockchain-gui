import { Connection, ServiceConnectionName } from '@xxch-network/api';
import { useGetWalletConnectionsQuery } from '@xxch-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@xxch-network/core';
