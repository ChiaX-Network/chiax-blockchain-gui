import { NewFarmingInfo } from '@xxch-network/api';
import { useGetBlockchainStateQuery, useGetHarvestersQuery, useGetNewFarmingInfoQuery } from '@xxch-network/api-react';
import { Flex, FormatBytes, FormatLargeNumber, CardSimple, useCurrencyCode } from '@xxch-network/core';
...
export default function HarvesterOverview() {
  ...
  const isTestnet = (useCurrencyCode() ?? 'XXCH').toUpperCase() === 'TXXCH';
