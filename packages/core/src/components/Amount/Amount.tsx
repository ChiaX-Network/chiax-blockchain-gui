...
import xxchToMojo from '../../utils/xxchToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isXxchCurrency = ['XXCH', 'TXXCH'].includes(currencyCode);
  const mojo = isXxchCurrency ? xxchToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isXxchCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
