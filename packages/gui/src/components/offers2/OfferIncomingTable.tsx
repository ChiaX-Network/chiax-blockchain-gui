...
import { Card, Flex, Table, LoadingOverlay, Button, useShowError, Tooltip, useCurrencyCode } from '@xxch-network/core';
import { Offers as OffersIcon } from '@xxch-network/icons';
