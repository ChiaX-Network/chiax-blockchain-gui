...
import { useGetDIDQuery, useGetDIDNameQuery, useSetDIDNameMutation } from '@xxch-network/api-react';
import { Color, CopyToClipboard, Flex, Loading, Tooltip, truncateValue } from '@xxch-network/core';
