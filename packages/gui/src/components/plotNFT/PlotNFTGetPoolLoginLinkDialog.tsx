import type { PlotNFT, PlotNFTExternal } from '@xxch-network/api';
import { useGetPoolLoginLinkQuery } from '@xxch-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@xxch-network/core';
