import type { UnconfirmedPlotNFT } from '@xxch-network/api';
import { useGetTransactionQuery } from '@xxch-network/api-react';
import { Flex, Link, Loading } from '@xxch-network/core';
