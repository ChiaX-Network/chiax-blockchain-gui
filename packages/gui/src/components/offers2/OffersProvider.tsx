...
import { useGetOfferSummaryMutation, useCheckOfferValidityMutation } from '@xxch-network/api-react';
import { isValidURL } from '@xxch-network/core';
...
const log = debug('xxch-gui:OfferProvider');
