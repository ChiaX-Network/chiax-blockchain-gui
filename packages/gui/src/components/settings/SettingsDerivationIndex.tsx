import { SyncingStatus } from '@xxch-network/api';
import { useExtendDerivationIndexMutation, useGetCurrentDerivationIndexQuery } from '@xxch-network/api-react';
import { AlertDialog, ButtonLoading, Flex, Form, TextField, useOpenDialog } from '@xxch-network/core';
import { useWalletState } from '@xxch-network/wallets';
