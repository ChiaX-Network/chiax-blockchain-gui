import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@xxch-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@xxch-network/core';
import { Reload } from '@xxch-network/icons';
