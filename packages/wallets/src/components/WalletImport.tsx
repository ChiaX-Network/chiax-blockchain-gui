import { english } from '@xxch-network/api';
import { useAddPrivateKeyMutation } from '@xxch-network/api-react';
import {
  AlertDialog,
  Autocomplete,
  Button,
      ...
      <Container maxWidth="lg">
        <Flex flexDirection="column" gap={3} alignItems="center">
          ...
          <Typography variant="subtitle1" align="center">
            <Trans>
              Enter the {mnemonicWordCount} word mnemonic that you have saved in order to restore your Xxch wallet.
            </Trans>
          </Typography>
