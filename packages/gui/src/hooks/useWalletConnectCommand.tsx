import api, { store, useGetLoggedInFingerprintQuery } from '@xxch-network/api-react';
import { useOpenDialog, useAuth } from '@xxch-network/core';
...
const log = debug('xxch-gui:walletConnectCommand');
