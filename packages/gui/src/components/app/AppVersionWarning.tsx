import { Button, Flex } from '@xxch-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Xxch application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Xxch services version: {backV}
                <br />
                Xxch application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Xxch application and stop all Xxch services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
