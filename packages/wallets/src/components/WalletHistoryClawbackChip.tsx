import { TransactionType } from '@xxch-network/api';
import type { Transaction } from '@xxch-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@xxch-network/api-react';
