...
import { NFTInfo } from '@xxch-network/api';
...
import AppIcon from '../assets/img/xxch64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import xxchEnvironment from '../util/xxchEnvironment';
...
// Set the userData directory to its location within XXCH_ROOT/gui
setUserDataDir();
...
const ensureCorrectEnvironment = () => {
  ...
  if (!xxchEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
    app.quit();
    return false;
  }
...
if (ensureSingleInstance() && ensureCorrectEnvironment()) {
  ...
  const createWindow = async () => {
    if (manageDaemonLifetime(NET)) {
      xxchEnvironment.startXxchDaemon();
    }
...
function getMenuTemplate() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'Xxch Blockchain Wiki' }),
          click: () => {
            openExternal('https://github.com/Chiax-Network/xxch-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/Chiax-Network/xxch-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/Chiax-Network/xxch-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/Chiax-Network/xxch-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/Chiax-Network/xxch-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/xxch');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/xxch_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // Xxch Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'Xxch' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About Xxch Blockchain' }),
          click: () => {
            openAbout();
          },
        },
