import { Connection } from '@xxch-network/api';
import { useGetFullNodeConnectionsQuery } from '@xxch-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@xxch-network/core';
