import { useRefreshPlotsMutation } from '@xxch-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@xxch-network/core';
import { Plots } from '@xxch-network/icons';
