import type { CATToken } from '@xxch-network/api';
import { SyncingStatus } from '@xxch-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@xxch-network/api-react';
import { Back, Flex, Loading, useShowError } from '@xxch-network/core';
