import type { OfferSummaryRecord, Wallet } from '@xxch-network/api';
import { useTakeOfferMutation } from '@xxch-network/api-react';
import { AlertDialog, xxchToMojo, useOpenDialog, useShowError } from '@xxch-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? xxchToMojo(fee) : new BigNumber(0);
