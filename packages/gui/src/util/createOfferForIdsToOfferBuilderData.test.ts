import * as xxchCore from '@xxch-network/core';
...
describe('createOfferForIdsToOfferBuilderData', () => {
  ...
  describe('when offering XXCH for CAT', () => {
    it('should return a valid offer builder data object', () => {
      ...
      xxchCore.mojoToXxch.mockReturnValue(new BigNumber(111.555));
      xxchCore.mojoToCAT.mockReturnValue(new BigNumber(600));
  ...
  describe('when offering a CAT for XXCH', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      xxchCore.mojoToXxch.mockReturnValue(new BigNumber(2));
      xxchCore.mojoToCAT.mockReturnValue(new BigNumber(1.234));
  ...
  describe('when offering XXCH for an NFT', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      xxchCore.mojoToXxch.mockReturnValue(new BigNumber(3));
  ...
  describe('when the offered asset is for an unknown wallet type', () => {
    it('should ignore the unknown wallet assets', () => {
      ...
      xxchCore.mojoToXxch.mockReturnValue(new BigNumber(0.5));
  ...
  describe('when lookupByWalletId throws', () => {
    ...
    it('should ignore the asset that caused the error', () => {
      ...
      xxchCore.mojoToXxch.mockReturnValue(new BigNumber(5));
      xxchCore.mojoToCAT.mockReturnValue(new BigNumber(1000));
