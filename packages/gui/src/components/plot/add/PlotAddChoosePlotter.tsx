import { defaultPlotter, PlotterName } from '@xxch-network/api';
import type { Plotter, PlotterMap } from '@xxch-network/api';
import { useGetPlottersQuery } from '@xxch-network/api-react';
import { CardStep, Select, StateColor } from '@xxch-network/core';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function getDisplayablePlotters(p: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => (a === PlotterName.XXCHPOS ? -1 : a.localeCompare(b)));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default Xxch Proof of Space plotter. If unsure, use the default Xxch Proof of Space plotter.
        </Trans>
      </Typography>
