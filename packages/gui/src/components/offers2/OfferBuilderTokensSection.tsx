...
import { useGetWalletsQuery } from '@xxch-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@xxch-network/core';
import { Tokens } from '@xxch-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Xxch Asset Tokens (CATs) are tokens built on top of XXCH</Trans>}
