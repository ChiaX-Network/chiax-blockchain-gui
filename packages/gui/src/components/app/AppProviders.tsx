...
import WalletConnectProvider, { WalletConnectXxchProjectId } from '../walletConnect/WalletConnectProvider';
                        ...
                        <AddressBookProvider>
                          <OffersProvider>
                            <NotificationsProvider>
                              <WalletConnectProvider projectId={WalletConnectXxchProjectId}>
