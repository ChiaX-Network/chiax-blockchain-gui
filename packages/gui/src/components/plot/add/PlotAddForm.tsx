import { defaultPlotter, toBech32m, fromBech32m, WalletCreatePool } from '@xxch-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@xxch-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@xxch-network/core';
