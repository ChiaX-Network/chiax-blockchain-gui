import { useGetAutoClaimQuery, useSetAutoClaimMutation } from '@xxch-network/api-react';
...
export default function SettingsCustodyAutoClaim(props) {
  ...
  const autoClaimFee = autoClaimData?.txFee ? mojoToXxch(autoClaimData.txFee).toNumber() : 0;
