import { type Plot } from '@xxch-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@xxch-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@xxch-network/core';
