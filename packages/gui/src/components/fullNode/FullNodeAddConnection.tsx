import { useOpenFullNodeConnectionMutation } from '@xxch-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@xxch-network/core';
