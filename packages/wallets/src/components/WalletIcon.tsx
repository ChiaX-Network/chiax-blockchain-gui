import { WalletType, type Wallet } from '@xxch-network/api';
import { useGetCatListQuery } from '@xxch-network/api-react';
import { Flex, TooltipIcon, useCurrencyCode } from '@xxch-network/core';
import { CrCat } from '@xxch-network/icons';
