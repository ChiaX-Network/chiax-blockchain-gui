...
import { Select, useCurrencyCode } from '@xxch-network/core';
...
type BuildAssetSelectorListParams = {
  ...
  xxchCurrencyCode: string;
};

function buildAssetSelectorList(params: BuildAssetSelectorListParams): WalletOfferAssetSelection[] {
  const { wallets, catList, rows, otherRows, selectedWalletId, xxchCurrencyCode } = params;
