import { useGetNewFarmingInfoQuery } from '@xxch-network/api-react';
import { Link, Table, Card } from '@xxch-network/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/Chiax-Network/xxch-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
