import type { Connection } from '@xxch-network/api';
import { ServiceName } from '@xxch-network/api';
import { useGetFarmerFullNodeConnectionsQuery } from '@xxch-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@xxch-network/core';
