import { toBech32m, fromBech32m } from '@xxch-network/api';
import { useGetCurrentAddressQuery, useSendNotificationMutation } from '@xxch-network/api-react';
import {
  AlertDialog,
  Amount,
  ButtonLoading,
...
export default function NotificationSendDialog(props: NotificationSendDialogProps) {
  ...
  async function handleSubmit(values: NotificationSendDialogFormData) {
    ...
    const amountMojos = xxchToMojo(amount);
