import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@xxch-network/api-react';
import { Flex, State, Loading, StateTypography } from '@xxch-network/core';
