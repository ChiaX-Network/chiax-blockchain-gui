import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@xxch-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@xxch-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for XXCH, CATs, or
