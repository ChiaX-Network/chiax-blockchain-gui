import { OfferTradeRecord, toBech32m } from '@xxch-network/api';
import {
...
import { useIsWalletSynced } from '@xxch-network/wallets';
...
function OfferList(props: OfferListProps) {
  ...
  const testnet = useCurrencyCode() === 'TXXCH';
                  ...
                  <Flex flexDirection="column" gap={4} height="100%">
                    <Flex flexDirection="column" gap={2} flexGrow={1}>
                      ...
                      <Typography variant="body1" color="textSecondary">
                        <Trans>
                          Create a file that you can use to trade XXCH, Xxch Asset Tokens, or NFTs with no counter-party
                          risk.
                        </Trans>
                      </Typography>
                    </Flex>
...
export function CreateOffer() {
  ...
  const testnet = currencyCode === 'TXXCH';
