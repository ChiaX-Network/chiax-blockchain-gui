...
- Automatically refresh queries when data changed (using events from Xxch Blockchain).
...
import { useGetPublicKeysQuery } from '@xxch-network/api-react';
import { Loading } from '@xxch-network/core';
...
import { store, api } from '@xxch-network/api-react';
